...
public class frmPago extends javax.swing.JInternalFrame {
    ...
    public static String idtrabajo;
        ...
        txttotal_reservaLayout.setHorizontalGroup(
            ...
            .addGroup(txttotal_reservaLayout.createSequentialGroup()
                ...
                .addGroup(txttotal_reservaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(txttotal_reservaLayout.createSequentialGroup()
                        .addComponent(txtidtrabajo, javax.swing.GroupLayout.PREFERRED_SIZE, 78, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txttrabajo, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        ...
        if (accion.equals("guardar")) {
            if (func.insertar(dts)) {
                ...
                ftrabajo func2 = new ftrabajo();
                vtrabajo dts2 = new vtrabajo();
                
                dts2.setIdtrabajo(Integer.parseInt(txtidtrabajo.getText()));
