...
public class freserva {
   ...
   public DefaultTableModel mostrar(String buscar){
       ...
       String [] titulos = {"ID","Idtrabajo","Contacto","idcliente","Cliente","idtrabajador","Trabajador","Tipo Reserva","Fecha Reserva","Fecha Ingreso","Fecha Salida","Costo","Estado"};
       ...
       sSQL="select r.idreserva,r.idtrabajo,h.contacto,r.idcliente,"+
               ...
               "r.costo_reserva,r.estado from reserva r inner join trabajo h on r.idtrabajo=h.idtrabajo where r.fecha_reserva like '%"+ buscar + "%' order by idreserva desc";
       ...
       try {
           ...
           while(rs.next()){
               ...
               registro [1]=rs.getString("idtrabajo");
               registro [2]=rs.getString("contacto");
   ...
   public boolean insertar (vreserva dts){
       sSQL="insert into reserva (idtrabajo,idcliente,idtrabajador,tipo_reserva,fecha_reserva,fecha_ingresa,fecha_salida,costo_reserva,estado)" +
               "values (?,?,?,?,?,?,?,?,?)";
       try {
           ...
           pst.setDouble(8, dts.getCosto_reserva());
   ...
   public boolean editar (vreserva dts){
       sSQL="update reserva set idtrabajo=?,idcliente=?,idtrabajador=?,tipo_reserva=?,fecha_reserva=?,fecha_ingresa=?,fecha_salida=?,costo_reserva=?,estado=?"+
               " where idreserva=?";
